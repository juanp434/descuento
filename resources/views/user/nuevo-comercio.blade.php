    ...
    <div class="content">
        ...
        <div class="wrap comercio">
            <form action="">
                ...
                <div class="input-group"><label for="pass">Contraseña</label><input type="text" id="pass" name="pass"></div>
                <div class="input-group"><label for="pass2">Confirmar</label><input type="text" id="pass2" name="pass2"></div>
                <div class="text-center"><input type="checkbox"><label for="">Acepto Terminos</label></div>
                <div class="text-center"><button type="submit">Suscribite</button></div>
            </form>
        </div>
    </div>
</div>  
